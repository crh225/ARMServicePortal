      ...
      <td>
        {resource.estimatedMonthlyCost !== null && resource.estimatedMonthlyCost !== undefined ? (
          <span className="cost-value">
            <span className="estimated-cost" title="Estimated monthly cost based on provisioned capacity">
              ${resource.estimatedMonthlyCost.toFixed(2)}/mo
            </span>
            {resource.cost !== null && resource.cost !== undefined && (
              <span className="actual-cost" title="Actual cost (last 30 days)">
                (${resource.cost.toFixed(2)} actual)
              </span>
            )}
            {resource.estimatedMonthlyCost > 10 && (
