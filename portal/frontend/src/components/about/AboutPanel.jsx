  ...
  return (
    <div className="about-panel">
      ...
      <div className="about-content">
        ...
        <section className="about-section about-section--full">
          <h2 className="about-section-title">Technologies</h2>
          <div className="about-tech-grid">
            <div className="about-tech-card">
              <div className="about-tech-icon" style={{ background: "linear-gradient(135deg, #7B42BC, #5C4EE5)" }}>
            ...
            <div className="about-tech-card">
              <div className="about-tech-icon" style={{ background: "linear-gradient(135deg, #1572B6, #0D5B99)" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
            ...
            <div className="about-tech-card">
              <div className="about-tech-icon" style={{ background: "linear-gradient(135deg, #EF7B4D, #E05D44)" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
            ...
            <div className="about-tech-card">
              <div className="about-tech-icon" style={{ background: "linear-gradient(135deg, #24292e, #1b1f23)" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
        ...
        <div className="about-row">
          ...
          <section className="about-section">
            <h2 className="about-section-title">GitOps Workflow</h2>
            <p className="about-text">
          ...
          {/* Support Section */}
          <section className="about-section">
            <h2 className="about-section-title">Need Help?</h2>
            <p className="about-text">
